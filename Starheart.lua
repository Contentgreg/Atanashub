...
-- Run for current and future characters
...
game:GetService("RunService").Heartbeat:Connect(function()
    ...
    pcall(function()
        ...
        if Settings.SpeedEnabled and humanoid.MoveDirection.Magnitude > 0 then
        ...
        -- Jump Bypass (Force Method)

        if Settings.JumpEnabled then

            -- Set the property just in case the game uses it
            ...
            -- If the game is forcing jump height to 0, this helps:
